...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=28&pause=1000&color=00F7FF&center=true&vCenter=true&width=600&lines=Hey+there%2C+I'm+Shadipto+Pranto+%F0%9F%91%8B;CS+Student+%7C+Problem+Solver;Code.+Debug.+Repeat." alt="Typing SVG" />
</div>
...
└─$ cat daily_routine.sh
  ...
  20:00  📖  Read docs / watch tutorials
  23:00  🚀  git push && sleep
```
...
└─$ git log --oneline --graph
  ...
  * a3f9d1c  ✨ feat: learned something new today
  * b2c8e4a  🐛 fix: that one bug from yesterday
  * c1d7f3b  📝 docs: updated README (again)
  * d0e6a2c  🔥 chore: deleted unused code (RIP)
  * e9f5b1d  🚀 init: another side project begins
```
